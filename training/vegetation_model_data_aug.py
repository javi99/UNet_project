...
image_generator = image_data_generator.flow_from_directory("dataGray/train_images/", 
                                                           seed=seed, 
...
mask_generator = mask_data_generator.flow_from_directory("dataGray/train_masks/", 
                                                         seed=seed, 
                                                         batch_size=batch_size,
...
valid_img_generator = image_data_generator.flow_from_directory("dataGray/val_images/", 
                                                               seed=seed, 
                                                               batch_size=batch_size,
                                                               color_mode = 'grayscale', 
                                                               #target_size = (128,128),
                                                               class_mode=None) #Default batch size 32, if not specified here
valid_mask_generator = mask_data_generator.flow_from_directory("dataGray/val_masks/", 
                                                               seed=seed, 
                                                               batch_size=batch_size, 
                                                               color_mode = 'grayscale',   #Read masks in grayscale
                                                               #target_size = (128,128),
...
num_train_imgs = len(os.listdir('dataGray/train_images/train/'))
...
model = tf.keras.models.load_model("modelo8.hdf5", compile=False)

test_img_generator = image_data_generator.flow_from_directory("dataGray/test_images/", 
                                                              seed=seed, 
                                                              batch_size=12,
                                                              color_mode = 'grayscale', 
                                                              target_size = (128,128),
...
test_mask_generator = mask_data_generator.flow_from_directory("dataGray/test_masks/", 
                                                              seed=seed, 
                                                              batch_size=12, 
                                                              color_mode = 'grayscale',   #Read masks in grayscale
                                                              target_size = (128,128),
